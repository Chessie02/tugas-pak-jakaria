...
// Vektor untuk menyimpan data komputer
vector<Komputer> dataKomputer;

// Fungsi untuk menambah data komputer
void tambahKomputer() {
    Komputer k;
...
// Fungsi untuk mengedit data komputer
void editKomputer() {
    string kode;
...
// Fungsi untuk menghapus data komputer
void hapusKomputer() {
    string kode;
...
// Fungsi untuk melihat data komputer
void lihatKomputer() {
...
// Fungsi untuk mencetak data komputer
void cetakKomputer() {
